...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-brand-700 text-white hover:bg-brand-800 focus:ring-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700';
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-600 hover:bg-gray-50 focus:ring-brand-600 border border-gray-200 dark:text-gray-300 dark:bg-dark-eval-1 dark:border-gray-600 dark:hover:bg-dark-eval-2 dark:hover:text-gray-100';
        break;
        case 'success':
        ...
        break;
        default:
            $variantClasses = 'bg-brand-700 text-white hover:bg-brand-800 focus:ring-brand-600';
    }
